...
class TestBuiltin(unittest.TestCase):
    ...
    def test_retval(self):
        ...
        # def test_func(self):
        # TODO: func - Function is printing garbage!
        # cmd = """test=func; sleep 1 & sleep 15 & ../.././build-release/src/bpftrace -e \
        # 'k:do_nanosleep  { printf(\"SUCCESS '$test' %s\\n\", func); exit(); }' \
        #  | grep '^SUCCESS '$test' [a-z][a-z]*$' || echo "FAILURE $test"
        # """
        ...
        # TODO: username is also printing garbage!
        # cmd = """test=username; sleep 1 & sleep 15 & ../.././build-release/src/bpftrace -e \
        # 'k:do_nanosleep  { printf(\"SUCCESS '$test' %s\\n\", username); exit(); }' \
        #  | grep '^SUCCESS '$test' [a-z][a-z]*$' || echo "FAILURE $test"
        # """
