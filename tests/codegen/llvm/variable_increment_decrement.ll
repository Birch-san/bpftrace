...
entry:
  ...
  %18 = getelementptr %printf_t.1, %printf_t.1* %printf_args5, i32 0, i32 0
  store i64 2, i64* %18
  %19 = load i64, i64* %"$x"
  %20 = sub i64 %19, 1
  store i64 %20, i64* %"$x"
  %21 = getelementptr %printf_t.1, %printf_t.1* %printf_args5, i32 0, i32 1
  store i64 %19, i64* %21
  ...
  %22 = bitcast %printf_t.1* %printf_args5 to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %22)
  %23 = bitcast %printf_t.2* %printf_args9 to i8*
  ...
  %25 = getelementptr %printf_t.2, %printf_t.2* %printf_args9, i32 0, i32 0
  store i64 3, i64* %25
  %26 = load i64, i64* %"$x"
  %27 = sub i64 %26, 1
  store i64 %27, i64* %"$x"
  %28 = getelementptr %printf_t.2, %printf_t.2* %printf_args9, i32 0, i32 1
  store i64 %27, i64* %28
  ...
  %29 = bitcast %printf_t.2* %printf_args9 to i8*
