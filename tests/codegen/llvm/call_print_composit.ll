...
helper_merge:                                     ; preds = %entry
  ...
  %18 = bitcast %print_tuple_72_t* %print_tuple_72_t to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %18)
  %19 = getelementptr %print_tuple_72_t, %print_tuple_72_t* %print_tuple_72_t, i64 0, i32 0
  store i64 30007, i64* %19
  %20 = getelementptr %print_tuple_72_t, %print_tuple_72_t* %print_tuple_72_t, i64 0, i32 1
  store i64 0, i64* %20
  %21 = getelementptr %print_tuple_72_t, %print_tuple_72_t* %print_tuple_72_t, i32 0, i32 2
  %22 = bitcast [72 x i8]* %21 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 1 %22, i8 0, i64 72, i1 false)
  %23 = bitcast [72 x i8]* %21 to i8*
  %24 = bitcast %"int64_string[64]__tuple_t"* %tuple to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %23, i8* align 1 %24, i64 72, i1 false)
  ...
  %25 = bitcast %print_tuple_72_t* %print_tuple_72_t to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %25)
  %26 = bitcast %"int64_string[64]__tuple_t"* %tuple to i8*
