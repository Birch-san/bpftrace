...
helper_merge:                                     ; preds = %entry
  ...
  %12 = getelementptr i64, i64* %11, i64 13
  %arg1 = load volatile i64, i64* %12
  %13 = add i64 %arg1, 1
  %str.min.cmp = icmp ule i64 %13, 64
  %str.min.select = select i1 %str.min.cmp, i64 %13, i64 64
  ...
  call void @llvm.memset.p0i8.i64(i8* align 8 %16, i64 0, i64 64, i1 false)
  %17 = load i64, i64* %strlen
  %probe_read_str = call i64 inttoptr (i64 45 to i64 ([64 x i8]*, i32, i64)*)([64 x i8]* %lookup_str_map, i64 %17, i64 %arg0)
