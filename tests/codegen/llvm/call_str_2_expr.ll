...
helper_merge:                                     ; preds = %entry
  %8 = getelementptr i8, i8* %0, i64 104
  %9 = bitcast i8* %8 to i64*
  %arg1 = load volatile i64, i64* %9, align 8
  %10 = add i64 %arg1, 1
  %11 = icmp ult i64 %10, 64
  %str.min.select = select i1 %11, i64 %10, i64 64
  %12 = getelementptr i8, i8* %0, i64 112
  %13 = bitcast i8* %12 to i64*
  %arg0 = load volatile i64, i64* %13, align 8
  %probe_read = call i64 inttoptr (i64 4 to i64 ([64 x i8]*, i32, [64 x i8]*)*)([64 x i8]* nonnull %lookup_str_map, i32 64, [64 x i8]* inttoptr (i64 37540848 to [64 x i8]*))
  %probe_read_str = call i64 inttoptr (i64 45 to i64 ([64 x i8]*, i32, i64)*)([64 x i8]* nonnull %lookup_str_map, i64 %str.min.select, i64 %arg0)
