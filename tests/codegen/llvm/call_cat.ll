...
entry:
  ...
  %lookup_fmtstr_map = call %cat_t* inttoptr (i64 1 to %cat_t* (i64, i32*)*)(i64 %pseudo, i32* nonnull %key)
  %2 = icmp eq %cat_t* %lookup_fmtstr_map, null
...
helper_merge:                                     ; preds = %entry
  %probe_read = call i64 inttoptr (i64 4 to i64 (%cat_t*, i32, %cat_t*)*)(%cat_t* nonnull %lookup_fmtstr_map, i32 8, %cat_t* inttoptr (i64 37471120 to %cat_t*))
  %8 = getelementptr %cat_t, %cat_t* %lookup_fmtstr_map, i64 0, i32 0
  store i64 20000, i64* %8, align 8
  %pseudo2 = call i64 @llvm.bpf.pseudo(i64 1, i64 1)
  %perf_event_output3 = call i64 inttoptr (i64 25 to i64 (i8*, i64, i64, %cat_t*, i64)*)(i8* %0, i64 %pseudo2, i64 4294967295, %cat_t* nonnull %lookup_fmtstr_map, i64 8)
  %9 = bitcast %cat_t* %lookup_fmtstr_map to i8*
