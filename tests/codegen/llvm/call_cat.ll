...
entry:
  ...
  %lookup_fmtstr_map = call %cat_t* inttoptr (i64 1 to %cat_t* (i64, i32*)*)(i64 %pseudo, i32* %key)
  %2 = sext %cat_t* %lookup_fmtstr_map to i32
  %3 = icmp ne i32 %2, 0
...
helper_merge:                                     ; preds = %entry
  %10 = bitcast %cat_t* %lookup_fmtstr_map to i8*
  call void @llvm.memset.p0i8.i64(i8* align 8 %10, i64 0, i64 8, i1 false)
  %11 = getelementptr %cat_t, %cat_t* %lookup_fmtstr_map, i32 0, i32 0
  store i64 20000, i64* %11
  ...
  %12 = bitcast %cat_t* %lookup_fmtstr_map to i8*
