...
helper_merge:                                     ; preds = %entry
  ...
  %16 = bitcast i64* %"&&_result" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %16)
  %17 = load i64, i64* %"$foo", align 8
  %18 = add i64 %17, 0
  %19 = bitcast i32* %"struct Foo.m" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %19)
  %probe_read_user = call i64 inttoptr (i64 112 to i64 (i32*, i32, i64)*)(i32* %"struct Foo.m", i32 4, i64 %18)
  %20 = load i32, i32* %"struct Foo.m", align 4
  %21 = sext i32 %20 to i64
  %22 = bitcast i32* %"struct Foo.m" to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %22)
  %lhs_true_cond = icmp ne i64 %21, 0
  br i1 %lhs_true_cond, label %"&&_lhs_true", label %"&&_false"

"&&_lhs_true":                                    ; preds = %helper_merge
...
"&&_false":                                       ; preds = %"&&_lhs_true", %helper_merge
