...
helper_merge:                                     ; preds = %entry
  ...
  %15 = bitcast i32* %"struct Bar.x" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %15)
  %probe_read = call i64 inttoptr (i64 4 to i64 (i32*, i32, [4 x i8]*)*)(i32* %"struct Bar.x", i32 4, [4 x i8]* %14)
  %16 = load i32, i32* %"struct Bar.x"
