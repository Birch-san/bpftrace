...
entry:
  ...
  %9 = sext i16 %8 to i64
  %10 = bitcast i64* %"@b_val" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* nonnull %10)
  store i64 %9, i64* %"@b_val", align 8
  %11 = bitcast i64* %"@b_key" to i8*
  ...
  %16 = bitcast i64* %"@c_val" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* nonnull %16)
  store i64 %15, i64* %"@c_val", align 8
  %17 = bitcast i64* %"@c_key" to i8*
