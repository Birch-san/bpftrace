...
helper_merge:                                     ; preds = %entry
  ...
  %14 = bitcast i64* %"struct Foo.bar" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %14)
  %probe_read = call i64 inttoptr (i64 4 to i64 (i64*, i32, [8 x i8]*)*)(i64* %"struct Foo.bar", i32 8, [8 x i8]* %13)
  %15 = load i64, i64* %"struct Foo.bar"
  %16 = bitcast i64* %"struct Foo.bar" to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %16)
  %17 = add i64 %15, 0
  %18 = bitcast i32* %"struct Bar.x" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %18)
  %probe_read2 = call i64 inttoptr (i64 4 to i64 (i32*, i32, i64)*)(i32* %"struct Bar.x", i32 4, i64 %17)
  %19 = load i32, i32* %"struct Bar.x"
  %20 = sext i32 %19 to i64
  %21 = bitcast i32* %"struct Bar.x" to i8*
