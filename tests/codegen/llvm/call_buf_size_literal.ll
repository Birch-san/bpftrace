...
entry:
  ...
  %lookup_buf_map = call %buffer_1_t* inttoptr (i64 1 to %buffer_1_t* (i64, i32*)*)(i64 %pseudo, i32* nonnull %key)
  %2 = icmp eq %buffer_1_t* %lookup_buf_map, null
...
helper_merge:                                     ; preds = %entry
  %probe_read = call i64 inttoptr (i64 4 to i64 (%buffer_1_t*, i32, %buffer_1_t*)*)(%buffer_1_t* nonnull %lookup_buf_map, i32 16, %buffer_1_t* inttoptr (i64 36483456 to %buffer_1_t*))
  %8 = getelementptr %buffer_1_t, %buffer_1_t* %lookup_buf_map, i64 0, i32 0
  store i64 1, i64* %8, align 8
  %9 = getelementptr %buffer_1_t, %buffer_1_t* %lookup_buf_map, i64 0, i32 1
  %10 = getelementptr inbounds [1 x i8], [1 x i8]* %9, i64 0, i64 0
  call void @llvm.memset.p0i8.i64(i8* %10, i64 0, i64 1, i32 1, i1 false)
  %11 = getelementptr i8, i8* %0, i64 112
  %12 = bitcast i8* %11 to i64*
  %arg0 = load volatile i64, i64* %12, align 8
  %probe_read2 = call i64 inttoptr (i64 4 to i64 ([1 x i8]*, i32, i64)*)([1 x i8]* %9, i64 1, i64 %arg0)
  ...
  %update_elem = call i64 inttoptr (i64 2 to i64 (i64, i64*, %buffer_1_t*, i64)*)(i64 %pseudo3, i64* nonnull %"@x_key", %buffer_1_t* nonnull %lookup_buf_map, i64 0)
