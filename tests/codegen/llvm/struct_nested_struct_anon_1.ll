...
helper_merge:                                     ; preds = %entry
  ...
  %13 = add [4 x i8]* %"lookup_$foo_map", i64 0
  %14 = add [4 x i8]* %13, i64 0
  %15 = bitcast i32* %"struct Foo::(anonymous at definitions.h:1:14).x" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %15)
  %probe_read = call i64 inttoptr (i64 4 to i64 (i32*, i32, [4 x i8]*)*)(i32* %"struct Foo::(anonymous at definitions.h:1:14).x", i32 4, [4 x i8]* %14)
  %16 = load i32, i32* %"struct Foo::(anonymous at definitions.h:1:14).x"
  %17 = sext i32 %16 to i64
  %18 = bitcast i32* %"struct Foo::(anonymous at definitions.h:1:14).x" to i8*
