...
entry:
  ...
  %"lookup_$foo_map" = call [2 x i8]* inttoptr (i64 1 to [2 x i8]* (i64, i32*)*)(i64 %pseudo, i32* %key)
  %2 = sext [2 x i8]* %"lookup_$foo_map" to i32
  %3 = icmp ne i32 %2, 0
...
helper_merge:                                     ; preds = %entry
  %10 = bitcast [2 x i8]* %"lookup_$foo_map" to i8*
  call void @llvm.memset.p0i8.i64(i8* align 8 %10, i64 0, i64 2, i1 false)
  %11 = bitcast [2 x i8]* %"lookup_$foo_map" to i8*
  %12 = bitcast i64 0 to i8 addrspace(64)*
  call void @llvm.memcpy.p0i8.p64i8.i64(i8* align 8 %11, i8 addrspace(64)* align 8 %12, i64 2, i1 false)
  %13 = add [2 x i8]* %"lookup_$foo_map", i64 0
  %14 = bitcast i16* %"struct Foo.x" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %14)
  %probe_read = call i64 inttoptr (i64 4 to i64 (i16*, i32, [2 x i8]*)*)(i16* %"struct Foo.x", i32 2, [2 x i8]* %13)
  %15 = load i16, i16* %"struct Foo.x"
  %16 = sext i16 %15 to i64
  %17 = bitcast i16* %"struct Foo.x" to i8*
