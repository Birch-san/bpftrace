...
helper_merge:                                     ; preds = %entry
  ...
  %14 = bitcast i32* %"struct Foo.x" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %14)
  %probe_read = call i64 inttoptr (i64 4 to i64 (i32*, i32, [4 x i8]*)*)(i32* %"struct Foo.x", i32 4, [4 x i8]* %13)
  %15 = load i32, i32* %"struct Foo.x"
  %16 = sext i32 %15 to i64
  %17 = bitcast i32* %"struct Foo.x" to i8*
