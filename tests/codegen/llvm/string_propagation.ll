...
lookup_success:                                   ; preds = %helper_merge
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %17, i8* align 1 %lookup_elem, i64 64, i1 false)
  br label %lookup_merge

lookup_failure:                                   ; preds = %helper_merge
  %18 = bitcast [64 x i8]* %lookup_elem_val to i8*
  call void @llvm.memset.p0i8.i64(i8* align 1 %18, i8 0, i64 64, i1 false)
  br label %lookup_merge

lookup_merge:                                     ; preds = %lookup_failure, %lookup_success
  %19 = bitcast i64* %"@x_key3" to i8*
