...
helper_merge:                                     ; preds = %entry
  %10 = bitcast [64 x i8]* %lookup_str_map to i8*
  call void @llvm.memset.p0i8.i64(i8* align 8 %10, i64 0, i64 64, i1 false)
  store [5 x i8] c"asdf\00", [64 x i8]* %lookup_str_map, align 8
  ...
  %14 = bitcast [64 x i8]* %lookup_elem_val to i8*
...
lookup_success:                                   ; preds = %helper_merge
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %15, i8* align 1 %lookup_elem, i64 64, i1 false)
...
lookup_merge:                                     ; preds = %lookup_failure, %lookup_success
  ...
  %20 = bitcast [64 x i8]* %lookup_elem_val to i8*
