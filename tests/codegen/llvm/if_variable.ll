...
helper_merge:                                     ; preds = %entry
  ...
  %probe_read = call i64 inttoptr (i64 4 to i64 (%printf_t*, i32, %printf_t*)*)(%printf_t* nonnull %lookup_fmtstr_map, i32 16, %printf_t* inttoptr (i64 140695077531744 to %printf_t*))
  ...
  store i64 %spec.select, i64* %10, align 8
