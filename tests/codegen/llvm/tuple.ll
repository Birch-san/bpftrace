...
helper_merge:                                     ; preds = %entry
  ...
  store [4 x i8] c"str\00", [64 x i8]* %lookup_str_map, align 8
  %14 = getelementptr %"int64_int64_string[64]__tuple_t", %"int64_int64_string[64]__tuple_t"* %tuple, i32 0, i32 2
  ...
  %19 = bitcast %"int64_int64_string[64]__tuple_t"* %tuple to i8*
